...
using INode = Conversa.Runtime.Interfaces.INode;

namespace Conversa.Editor
{
    public abstract class BaseNodeView<T> : Node, IDataMapper, IGroupable, INodeView where T: INode
    {
