...
namespace Conversa.Editor
{
	...
	{
		public UnityEvent<GraphViewChange> OnMoveElements { get; } = new UnityEvent<GraphViewChange>();
		public UnityEvent<GraphViewChange> OnDeleteElements { get; } = new UnityEvent<GraphViewChange>();
		public UnityEvent<GraphViewChange> OnNewElements { get; } = new UnityEvent<GraphViewChange>();
		public UnityEvent<NodeCreationContext> OnNodeCreationRequest { get; } = new UnityEvent<NodeCreationContext>();
		public UnityEvent<Group, IEnumerable<GraphElement>> OnElementsAddedToGroup { get; } = new UnityEvent<Group, IEnumerable<GraphElement>>();
		public UnityEvent<Group, IEnumerable<GraphElement>> OnElementsRemovedFromGroup { get; } = new UnityEvent<Group, IEnumerable<GraphElement>>();
